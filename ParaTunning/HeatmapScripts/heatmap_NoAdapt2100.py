...
def process_scenario(scenario_name):
    ...
    # Loading Data
    df = pd.read_csv(f"logs/ParaTunningFiles/NoAdapt2100/ParaTunning_NoAdapt_Gulf_2100_{scenario_name}.csv") 
    ...
    plt.savefig(f'logs/ParaTunningPlots/Heatmaps/NoAdapt2100/SSPRCP{scenario_name}/NoAdapt_Gulf_2100_{scenario_name}_n_estimators_vs_max_depth.png')
    plt.close()
    ...
    sns.heatmap(heatmap_data, annot=True, fmt='.3f', cmap='coolwarm', cbar_kws={'label': 'mean_test_score'})
    plt.title('Heatmap of mean_test_score with Categorical Parameters')
    plt.savefig(f'logs/ParaTunningPlots/Heatmaps/NoAdapt2100/SSPRCP{scenario_name}/NoAdapt_Gulf_2100_{scenario_name}_n_estimators_vs_min_samples_split.png')
    plt.close()
    ...
    sns.heatmap(heatmap_data, annot=True, fmt='.3f', cmap='coolwarm', cbar_kws={'label': 'mean_test_score'})
    plt.title('Heatmap of mean_test_score with Categorical Parameters')
    plt.savefig(f'logs/ParaTunningPlots/Heatmaps/NoAdapt2100/SSPRCP{scenario_name}/NoAdapt_Gulf_2100_{scenario_name}_max_depth_vs_min_samples_split.png')
    plt.close()
