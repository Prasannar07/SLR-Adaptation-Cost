...
def process_scenario(scenario_name):
   ...
   # Clear the lists at the beginning of each scenario
    ...
    result_df_sorted.to_csv(f"ParaTunningFiles/OptimalCost2050/ParaTunning_OptimalCost_Gulf_2050_{scenario_name}.csv", index=False)
...
if __name__ == '__main__':
    ...
    file_path = "ParaTunningDict/OptimalCost2050.pkl"
