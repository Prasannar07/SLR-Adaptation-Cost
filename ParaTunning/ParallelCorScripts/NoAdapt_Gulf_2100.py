...
def process_scenario(scenario_name):
   ...
   # Clear the lists at the beginning of each scenario
    ...
    result_df_sorted.to_csv(f"ParaTunningFiles/NoAdapt2100/ParaTunning_NoAdapt_Gulf_2100_{scenario_name}.csv", index=False)
...
if __name__ == '__main__':
    ...
    file_path = "ParaTunningDict/NoAdapt2100.pkl"
