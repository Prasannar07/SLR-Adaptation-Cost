...
def process_scenario(scenario_name, para_grid):
    ...
    plt.title(f"FeatureImp NoAdaptCost EntireGulf 2050 {scenario_name}")
    plt.xlabel("Segments")
    plt.ylabel("Feature Importance")
    plt.xticks(rotation=45, ha='right')
    plt.tight_layout()
    plt.savefig(f"logs/FeatureImpEntireGulfStackBarPlots/NoAdapt2050/FeatureImp_NoAdaptCost_EntireGulf_2050_{scenario_name}.png")
    ...
    save_path = f"logs/FeatureImpEntireGulfFiles/NoAdapt2050/FeatureImp_NoAdapt_EntireGulf_2050_{scenario_name}.csv"
