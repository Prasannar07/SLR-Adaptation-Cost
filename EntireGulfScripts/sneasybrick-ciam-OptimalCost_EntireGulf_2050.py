...
def process_scenario(scenario_name, para_grid):
    ...
    plt.title(f"FeatureImp OptimalCost EntireGulf 2050 {scenario_name}")
    plt.xlabel("Segments")
    plt.ylabel("Feature Importance")
    plt.xticks(rotation=45, ha='right')
    plt.tight_layout()
    plt.savefig(f"logs/FeatureImpEntireGulfStackBarPlots/OptimalCost2050/FeatureImp_OptimalCost_EntireGulf_2050_{scenario_name}.png")
    ...
    save_path = f"logs/FeatureImpEntireGulfFiles/OptimalCost2050/FeatureImp_OptimalCost_EntireGulf_2050_{scenario_name}.csv"
